class Fscore():
    ...
    def precision(self):
        """This function calculates precision, i.e. proportion of |collect answer| and |label in target|
        """
        self.tot_pre= []
    ...
    def recall(self):
        """This function calculates precision, i.e. proportion of |collect answer| and |label in prediction|
        """
